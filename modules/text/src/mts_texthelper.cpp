...
void 
MTS_TextHelper::generateTxtPatch(Mat& output,Mat& outputMask,String caption, 
  ...
  surface = cairo_image_surface_create (CAIRO_FORMAT_ARGB32, 2000, height);
...
void 
MTS_TextHelper::generateTxtSample(CV_OUT String &caption, CV_OUT Mat& sample,
				  CV_OUT Mat& sampleMask, int text_color, 
				  bool distract){
